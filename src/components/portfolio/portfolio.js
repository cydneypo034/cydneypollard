...
import crownclothing from '../images/crownclothesproj.png';
            ...
            <div >
                ...
                <section>
                    <div className="card-wrapper">
                        ...
                        <div className="card">
                            <img src={feminaku} alt="girl-with-pink-and-purple-tracksuit" className="image" />
                            <div className="overlay">
                        ...
                        <div className="card">
                            <img src={artist} alt="paintbrush-strokes-with-stores" className="image" />
                            <div className="overlay">
                        ...
                        <div className="card">
                            <img src={fiaworld} alt="three-cards-of-artists-featured" className="image" />
                            <div className="overlay">
                        ...
                        <div className="card">
                            <img src={pony} alt="my-little-pony-simon-says-game" className="image" />
                            <div className="overlay">
